...
<body>
    ...
    <script>
        ...
        // --- NEW CODE: GENERATE '01.jpg' through '26.jpg' POOL & PICK 3 UNIQUE CARDS ---
        const cardsFolder = 'cards/';
        let cardsPool = [];
        
        // Dynamically populate the pool with string names '01.jpg' up to '26.jpg'
        for (let i = 1; i <= 26; i++) {
            // Converts numbers like 5 into string '05' so file paths stay uniform
